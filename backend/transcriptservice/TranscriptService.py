...
#this is where the chunking is done. No overlapping
...
class TranscriptService:
    ...
    #from the insights create the transcript with timestamp and another transcript only, then upload to transcript db
